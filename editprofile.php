        ...
        <div class="row" style="justify-content: center;" >
          <div class="col-lg-6 d-flex align-items-stretch" data-aos="fade-up">
            <form method="post" role="form" class="php-email-form">
				<br><center><h2>Edit Profile Form</h2></center><br><br>
              <div class="row">
				<span>Username (Email) : </span>
                <div class="col-md-12 form-group">
                  <input type="email" value="<?php echo $data['custEmail'] ?>" class="form-control" placeholder="Enter your username (Email)" data-rule="minlen:4" data-msg="Please enter your username (Email)"  disabled />
                  <input type="hidden" name="custEmail" value="<?php echo $data['custEmail'] ?>" id="custEmail"  />
				  <div class="validate"></div>
				  <font color="red" style="font-size:13px;">Email cannot be update!.</font>
                </div><br><br>
              </div>
			  <div class="row">
				<span>Name : </span>
                <div class="col-md-12 form-group">
                  <input type="name" name="custName" value="<?php echo $data['custName'] ?>" class="form-control" id="custName" placeholder="Enter your name" data-rule="minlen:4" data-msg="Please enter your name"  />
                  <div class="validate"></div>
                </div><br><br>
              </div>
			  <div class="row">
                ...
                <div class="col-md-12 form-group">
                  <input type="text" name="custPhone" value="<?php echo $data['custPhone'] ?>" onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="form-control" id="custPhone" placeholder="Enter your phone number" data-rule="minlen:4" data-msg="Please enter your phone number"  />
                  <div class="validate"></div>
                </div><br><br>
              </div>
              <div class="mb-3">
              ...
              <div class="text-center"><button type="submit" class="btn" id="signup">Update <i style="font-size:18px;" class="bx bx-lock"></i></button></div>
			  <br>
			  <br><br>
            </form>
          </div>
...
$(document).ready(function(){
 $('#signup').click(function(){
  ...
  var custPhone = $('#custPhone').val();
	   ...
	   $.ajax({
		url:"updateCustomer_process.php",
		method:"POST",
		dataType:"json",
		data:{custEmail:custEmail,custPhone:custPhone,custName:custName},
		beforeSend:function(){
