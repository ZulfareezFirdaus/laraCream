...
if(isset($_SESSION['custEmail'])){
	...
	$sql = "SELECT orders.*,customer.*,payment.*,flavor.* FROM orders
	...
	WHERE orders.ordersID = '".$_SESSION["ordersID"]."' ";
	$query = mysqli_query($dbconn, $sql);
	$data = mysqli_fetch_assoc($query);
	
	$sql2 = "SELECT orders_detail.* ,orders.*,topping.* FROM orders_detail
        ...
        <div class="row" style="justify-content: center;" >
          <div class="col-lg-6 d-flex align-items-stretch" data-aos="fade-up">
            <form action="index.php" method="post" class="php-email-form">
			  <br><center><h2 style="z-index:999999;position: relative;" >Payment Success!</h2></center><br><br><br>
              ...
              <table width="100%">
				  <tr>
					<td>Payment ID :</td>
					<td style="text-align:right"><b>#YHT<?php echo $data['paymentID'] ?>PK</td>
				  </tr>
				  <tr>
					<td>Payment Type :</td>
					<td style="text-align:right"><b><?php echo $data['paymentType'] ?></td>
				  </tr>
				  <tr>
					<td>Amount Paid :</td>
					<td style="text-align:right"><b>RM <?php echo $data['paymentTotal'] ?></td>
				  </tr>
				  <tr>
					<td>Status :</td>
					<td style="text-align:right;color:green;"><b>Success</td>
				  </tr>
			  </table><br>
			  <hr></hr>
			  <table width="100%">
				  <tr>
					<td>Size Cup :</td>
					<td style="text-align:right"><b><?php echo $data['cupsize'] ?></td>
				  </tr>
				  <tr>
					<td>Flavor :</td>
					<td style="text-align:right"><b><?php echo $data['flavorName'] ?></td>
				  </tr>
				  <?php 
				  $number = 1;
				  ...
				  ?>
				  <tr>
					<td>Topping #<?php echo $number++ ?> : </td>
					<td style="text-align:right"><b><?php echo $data2['toppingName'] ?></td>
				  </tr>
				  <?php } ?>
				   
			  </table>
			  <br><br>
			  <div class="text-center"><a class="btn" href="index.php">Home <i style="font-size:18px;" class="bx bx-home"></i></a></div>
			  <br><br>
            </form>
          </div>
