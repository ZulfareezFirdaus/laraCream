...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.html"><img width="12%" src="assets/imgs/logo5.png" />&nbsp;<span>LaraCream</span></a></h1>
      </div>
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
		  ...
		  <li><a href="blog.html"><i style="font-size:16px;" class="bx bx-search"></i></a></li>
		  <li><a href="blog.html"><i style="font-size:16px;" class="bx bx-shopping-bag"></i></a></li>
        </ul>
      </nav><!-- .nav-menu -->
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Topping Details</h2>
          <ol>
            <li><a href="index.html">Home</a></li>
            <li><a href="toppings.php">Toppings</a></li>
            <li>Topping Details</li>
          </ol>
        </div>
      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="owl-carousel portfolio-details-carousel">
            <center><img style="width:50%" src="assets/imgs/ic-01.jpg" class="img-fluid" alt=""></center>
          </div>

          <div class="portfolio-info">
            <h3>Topping information</h3>
            <ul>
