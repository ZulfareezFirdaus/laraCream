<?php
    ...
    $query = "SELECT * FROM flavor WHERE flavorID = '$flavorID'";
...
//Bila user tekan save
  	if(isset($_POST["save"]))
  	{
        ...
        $flavorPrice = $_POST['flavorPrice'];
                        ...
                        $query = "UPDATE flavor SET flavorName = '$flavorName', flavorPrice = '$flavorPrice'
         			...
         			if ($link->query($query))
               			{
               				...
               				window.alert('Flavor information is edited!')
                ...
                <div class="container">
                    <div class="row">
                        <div class="section-title padd-15">
                            ...
                            <h3>Edit Flavor's Information</h3>
                        </div>
                    </div>
                            ...
                            <form method="POST" id="form" enctype="multipart/form-data"> 
                                <div class="form-field">
                                    <label>Flavor Name</label>
                                        <input type="text" id="flavorName" name="flavorName" class="form-control" value="<?php echo $row['flavorName']; ?>" required><br>
                                </div>
                                <div class="form-field">
                                    <label>Flavor Price (RM)</label>
                                        <input type="text" onkeypress="return isNumberKey(event)" id="flavorPrice" name="flavorPrice" class="form-control" value="<?php echo $row['flavorPrice']; ?>" required><br>
                                </div>
