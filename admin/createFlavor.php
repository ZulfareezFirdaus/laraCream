  		...
  		if(in_array($fileActualExt, $allowed))
  			{
  				if($fileError === 0)
  				{
  					...
  					{
                        $query = "INSERT INTO flavor(adminID, flavorName, flavorPrice, flavorImg)
                        VALUES ('".$adminID."','".$flavorName."', '".$flavorPrice."','assets/imgs/".$fileName."')";
                            ...
                            <form method="POST" id="form" enctype="multipart/form-data"> 
                                <div class="form-field">
                                    <label>Flavor Name</label>
                                        <input type="text" id="flavorName" name="flavorName" class="form-control" required><br>
                                </div>
                                <div class="form-field">
                                    <label>Flavor Price (RM)</label>
                                        <input type="text" onkeypress="return isNumberKey(event)" id="flavorPrice" name="flavorPrice" class="form-control" required><br>
                                </div>
                                <div class="form-field">
