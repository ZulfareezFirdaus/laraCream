        ...
        <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Email Us</h3>
                  <p>customerservice@laracream.com</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
          ...
          <div class="col-lg-6">
            <form action="#" method="post" role="form" class="php-email-form">
              ...
              <div class="text-center" ><button style="background: #e12323;border: none;padding: 11px 23px 11px 23px;color: white;" type="button">Send Message</button></div>
            </form>
          </div>
