        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active">Flavor View</li>
            </ul>
          </div>
        </div>
		...
		?>
          <div class="col-lg-3 col-md-6 filter-app">
            <div class="portfolio-item">
              <img src="<?php echo $data['flavorImg'] ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h3><a href="<?php echo $data['flavorImg'] ?>" data-gall="portfolioGallery" class="venobox" title="App 1"><?php echo $data['flavorName'] ?></a></h3>
                <div>
                  <a href="<?php echo $data['flavorImg'] ?>" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="bx bx-plus"></i></a>
                </div>
              </div>
            </div>
          </div>
