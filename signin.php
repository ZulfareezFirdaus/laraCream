        ...
        <div class="row" style="justify-content: center;" >
          <div class="col-lg-6 d-flex align-items-stretch" data-aos="fade-up">
            <form method="post" role="form" class="php-email-form">
				<br><center><h2>Login Form</h2></center><br><br>
              <div class="row">
				<span>Username : </span>
                <div class="col-md-12 form-group">
                  <input type="email" name="custEmail" class="form-control" id="custEmail" placeholder="Enter your username (Email)" data-rule="minlen:4" data-msg="Please enter your username (Email)" required />
                  <div class="validate"></div>
                </div><br><br>
              </div>
			  <span>Password : </span>
              <div class="col-md-12 form-group">
                <input type="password" class="form-control" name="custPassword" id="custPassword" placeholder="Enter your password" data-rule="minlen:4" data-msg="Please enter your password" required />
                <div class="validate"></div>
              </div>
              <div class="mb-3">
                <div class="sent-message">Sign In Successfully. Thank you!</div>
				<div class="not-match">Wrong email @ password, Please Try Again!</div>
				<div class="not-valid">Couldn't find your email, Please register first!</div>
				<div class="database-error">Database Error, Please Contact the Developer!. </div>
				<div class="Verify">Please verify first your email. </div>
              </div><br><br>
              <div class="text-center"><button type="submit" class="btn" id="signup">Sign In <i style="font-size:18px;" class="bx bx-lock"></i></button></div>
			  <br><br><br>
			  <center><span style="color: #ff0080;font-size: 15px;position: relative;top: -10px;" >Or Sign In with </span></center>
			  ...
			  <center><a href="signup.php" >Not register yet?</a>
			  <br><br>
            </form>
          </div>
   ...
   <script>
	$(document).ready(function(){
	 $('#signup').click(function(){
	  ...
	  if($.trim(custEmail).length > 0 && $.trim(custPassword).length > 0 )
	  {
	   $.ajax({
		url:"signin-process.php",
		method:"POST",
		dataType:"json",
		data:{custEmail:custEmail,custPassword:custPassword},
		beforeSend:function(){
